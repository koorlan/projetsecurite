...
public class AES {
	...
	final int Nk = 4;	//Nombre de mot dans la cl� (un mot = 4 octet) (4 pour AES-128)
 ...
 ****************************************************************************************************************/
	 ...
	 * @param kpub       la cle de chiffrement
	 */
	public AES(String Kpub){
		key = new int[Nk * 4];
		expandKey = new int[4 * Nk * (Nr +1)];
		
		//Decoupage de la cl� format texte en format integer
		for (int i=0;i< (Nk * 4);i++){
			key[i] = Integer.valueOf(Kpub.substring(i,i+1));
		}
		
		//Generation de rCon
		rCon = new AESWord128[16];
		genRCon();
		//Generation des cl�s �tendus
		expandKey = keyExpansion(key);
		
	}
	
	public AES(byte Kpub[]){
		key = new int[Nk * 4];
		expandKey = new int[4 * Nk * (Nr +1)];
 ...
 ****************************************************************************************************************/
	...
	public byte[] chiffrerMess(byte mess[]){
		...
		while (i<mess.length) {
			//Creation du bloc de 16bytes � chiffrer
			if (i+16<=mess.length){
				for (j=0; j<16;j++){
			...
			//Ajout des donn�es au tableau de resultat
	...
	/**
	 * Chiffre un bloc 16 bytes rang�s dans un tableau [4][4]
	 */
...
/****************************************************************************************************************
 * Construction des cl�s de rondes
 ****************************************************************************************************************/
	...
	/**
	 * Procede � la generation des cl�s de rondes 
	 */
	...
	/**
	 * Retourne la cl� de ronde de la ronde round 
	 * @round
	 */
	...
	/**
	 * Application de la sBox a un mot AES de cl� de ronde
	 * @param w
	 * @return
	 */
...
/****************************************************************************************************************
 * Construction des differents tableaux utilis�s
 ****************************************************************************************************************/
	/**
	 * Generation du tableau rCon utilis� pour cr�er les cl�s de rondes
	 */
 ...
 ****************************************************************************************************************/
	...
	/**
	 * Ajoute au tableau de byte in le tableau add d'int converit en byte � partir de la position pos
	 * @param in
	 * @param add
	 * @param pos
	 */
